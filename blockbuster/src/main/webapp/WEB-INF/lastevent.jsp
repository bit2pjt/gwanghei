...
<section>
    ...
    <div class="" style="width: 1200px; margin: 0 auto;">
    	...
    	<br>
    	<br>
    	<p style="color: #333; font-weight: bold; font-size: 20px; ">&nbsp;&nbsp; 지난 이벤트 </p>
    	<p style="color: #333; font-weight: bold; font-size: 14px; margin-bottom: 40px;">&nbsp;&nbsp;&nbsp; 지난 이벤트 <span style="color: red;">2458건</span> 있습니다.</p>
